        ...
        <div>
          ...
          <ul className="mt-4 flex flex-wrap justify-center gap-6">
            <li className="flex items-center text-zinc-600">
              ...
              <a href="mailto:info@ecoplanetas.com" className="text-sm ml-4">
            ...
            <li className="flex items-center text-zinc-600">
              ...
              <a href="https://wa.me/1134570444" target="_blank" rel="noopener noreferrer"  className="text-sm ml-4">
                <strong>+52 1134570444 </strong>
              </a>
            </li>
          </ul>
        </div>
