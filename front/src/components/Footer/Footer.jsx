...
const Footer = ({ onScroll }) => {
  ...
  <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
    ...
    {/* main container*/}
    <div className="h-[12rem] mx-6 py-5 text-center md:text-left">
      <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        {/* <!-- TW Elements section --> */}
        <div className="">
          <h6
            className="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start">
            <img src={hojaCiclo} className="mr-3 h-4 w-4" alt="png logo" />
            Eco Plantas
          </h6>
          <p>
            Sastre Marcos 123, Centro<br/>
            C.A.B.A, Buenos Aires<br/>
            Argentina<br/>
            Whatsapp: +54 000 000000<br/>
            Teléfono: +54 000 000-0000<br/>
          </p>
        </div>
        {/* <!-- Products section --> */}
